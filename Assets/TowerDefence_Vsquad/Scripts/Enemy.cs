...
public class Enemy : MonoBehaviour
{
    ...
    void Shooting()
    {
        //if (EnemyTarget)
        // {           
        GameObject c = GameObject.Instantiate(bullet, shootElement.position, Quaternion.identity) as GameObject;
        c.GetComponent<EnemyBullet>().target = target;
        c.GetComponent<EnemyBullet>().twr = this;
        // }  
